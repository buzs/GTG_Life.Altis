...
if(isNull _organThief) exitWith {}; //if not the thief get bent
	...
	[[1,format["%1 Removeu o rim de %2.",name _organThief,name player]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;//lets people know you are stealing kidneys
	[_organThief,"rim",1] call life_fnc_handleInv;//put stolen kidney into inventory of thief
