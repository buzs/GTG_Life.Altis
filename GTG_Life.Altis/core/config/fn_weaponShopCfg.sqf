			...
			default
			{
				["Loja Rebelde Level 2",
					[
						...
						["ToolKit",nil,500],
						["FirstAidKit",nil,200],
						["arifle_SDAR_F",nil,19000],
						["arifle_TRG20_F",nil,23750],
						["SMG_01_Holo_F",nil,23750],
						["SMG_02_F",nil,23750],
						["hgun_PDW2000_snds_F",nil,14250],
						["arifle_Katiba_F",nil,30000],
						["hgun_Pistol_heavy_02_F",nil,9357],
						["hgun_Pistol_heavy_01_F",nil,9357],
						["optic_Holosight",nil,5000],
						["optic_MRD",nil,5000],
						["optic_Hamr",nil,5000],
						["optic_MRCO",nil,5000],
			...
			default
			{
				["Loja Rebelde Level 3",
					[
						...
						["arifle_TRG20_F",nil,22500],
						["SMG_01_Holo_F",nil,22500],
						["SMG_02_F",nil,22500],
						["hgun_PDW2000_snds_F",nil,13500],
						["arifle_Katiba_F",nil,27000],
						["srifle_DMR_01_F",nil,70000],
						["LMG_Zafir_F",nil,100000],
						["hgun_Pistol_heavy_02_F",nil,8865],
						["hgun_Pistol_heavy_01_F",nil,8865],
						["hgun_Rook40_F",nil,6175],
						["optic_Holosight",nil,5000],
						["optic_MRD",nil,5000],
						["optic_Hamr",nil,5000],
						["optic_MRCO",nil,5000],
			...
			default
			{
				["Armas Premium",
					[
						...
						["SMG_01_Holo_F",nil,21250],
						["SMG_02_F",nil,21250],
						["hgun_PDW2000_snds_F",nil,17000],
						["arifle_Katiba_F",nil,25500],
						["arifle_MXC_F",nil,17000],
						["arifle_MX_F",nil,27200],
						["arifle_MX_SW_F",nil,29750],
						["arifle_MXM_F",nil,29750],
						["srifle_EBR_F",nil,68000],
						["srifle_DMR_01_F",nil,59500],
						["LMG_Mk200_F",nil,85000],
						["LMG_Zafir_F",nil,85000],
						["hgun_Pistol_heavy_02_F",nil,8372],
						["hgun_Pistol_heavy_01_F",nil,8372],
			...
			default
			{
				["Armas Premium",
					[
						...
						["SMG_02_F",nil,17500],
						["hgun_PDW2000_snds_F",nil,14000],
						["arifle_Katiba_F",nil,17850],
						["arifle_MXC_F",nil,14000],
						["arifle_MX_F",nil,22400],
						["arifle_MX_SW_F",nil,24500],
						["arifle_MXM_F",nil,24500],
						["srifle_EBR_F",nil,56000],
						["srifle_DMR_01_F",nil,49000],
						["LMG_Mk200_F",nil,70000],
						["LMG_Zafir_F",nil,70000],
						["hgun_Pistol_heavy_02_F",nil,6895],
						["hgun_Pistol_heavy_01_F",nil,6895],
			...
			default
			{
				["Armas Premium",
					[
						...
						["ToolKit",nil,500],
						["FirstAidKit",nil,200],
						["arifle_SDAR_F",nil,11000],
						["arifle_TRG20_F",nil,13750],
						["SMG_01_Holo_F",nil,13750],
						["SMG_02_F",nil,13750],
						["hgun_PDW2000_snds_F",nil,11000],
						["arifle_Katiba_F",nil,14025],
						["arifle_MXC_F",nil,11000],
						["arifle_MX_F",nil,17600],
						["arifle_MX_SW_F",nil,19250],
						["arifle_MXM_F",nil,19250],
						["srifle_EBR_F",nil,44000],
						["srifle_DMR_01_F",nil,38500],
						["LMG_Mk200_F",nil,55000],
						["LMG_Zafir_F",nil,55000],
						["hgun_Pistol_heavy_02_F",nil,5417],
						["hgun_Pistol_heavy_01_F",nil,5417],
						["hgun_Rook40_F",nil,3575],
						["optic_Holosight",nil,2000],
						["optic_MRD",nil,2000],
						["optic_Hamr",nil,2000],
						["optic_MRCO",nil,2000],
