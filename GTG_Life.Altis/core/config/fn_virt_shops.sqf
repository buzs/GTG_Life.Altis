...
switch (_shop) do
{
	case "market": {["Altis Market",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","boltcutter","storagesmall","nitro","storagebig","rosas","eter"]]};
	...
	case "heroin": {["Traficante de Drogas",["cocainep","heroinp","marijuana","lsd"]]};
	...
	case "cafe": {["Compradorer de Cafe",["cafe","cafet"]]};
	case "gold": {["Gold Buyer",["goldbar"]]};
	case "organ": {["Organ Dealer",["rim"]]};
	case "hospital": {["Eter de Petroleo",["eter"]]};
};