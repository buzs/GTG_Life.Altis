...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","apple_5","peaches_1","peaches_2","peaches_3","peaches_4","peaches_5","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","campocafe_1","campocafe_2","rosas_1"];
_zone = "";
...
_item = switch(true) do {
	case (_zone in ["apple_1","apple_2","apple_3","apple_4","apple_5"]): {"apple"};
	case (_zone in ["peaches_1","peaches_2","peaches_3","peaches_4","peaches_5"]): {"peach"};
	...
	case (_zone in ["campocafe_1","campocafe_2"]): {"cafet"};
	case (_zone in ["rosas_1"]): {"rosas"};
	default {""};
};
